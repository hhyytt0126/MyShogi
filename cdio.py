...
# C Prototype: long DioReadCountSR(short Id, short *ChNo, short ChNum, unsigned int *Count, unsigned short *Timestamp, unsigned char Mode);
...
# C Prototype: long DioDmGetDirection(short id, unsigned long *Direction);
DioDmGetDirection = cdio_dll.DioDmGetDirection
DioDmGetDirection.restype = ctypes.c_long
DioDmGetDirection.argtypes = [ctypes.c_short, ctypes.POINTER(ctypes.c_ulong)]
